...
-- ALTER STAGE pliki RENAME TO SFSimilarity;
...
RETURNS float
LANGUAGE java
IMPORTS = ('@SFSimilarity/commons-text-1.9.jar', '@SFSimilarity/commons-lang3-3.12.0.jar', '@sfsimilarity/SFSimilarity.jar')
...
RETURNS integer
LANGUAGE java
IMPORTS = ('@SFSimilarity/commons-text-1.9.jar', '@SFSimilarity/SFSimilarity.jar')
